      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6 max-w-3xl">
        ...
        <div className="p-6 rounded-xl border shadow-card" style={{ background: "hsl(var(--card))" }}>
          ...
          <div className="space-y-2 text-sm" style={{ color: "hsl(var(--muted-foreground))" }}>
            <div><span className="font-medium text-foreground">Name:</span> EduManage Pro School</div>
            <div><span className="font-medium text-foreground">Session:</span> 2024-25</div>
            <div><span className="font-medium text-foreground">Currency:</span> INR (₹)</div>
