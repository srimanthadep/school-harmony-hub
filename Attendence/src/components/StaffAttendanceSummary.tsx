import { sampleStaff, StaffAttendanceRecord } from "@/data/staff";
...
export default function StaffAttendanceSummary({
  ...
  return (
    <div className="w-full max-w-sm mx-auto animate-fade-in space-y-6">
      <h2 className="text-2xl font-bold text-center text-foreground">Staff Attendance Complete ✅</h2>
      ...
      <div className="rounded-2xl bg-card border border-border overflow-hidden">
        <div className="max-h-64 overflow-y-auto divide-y divide-border">
          {records.map((record) => {
            ...
            return (
              <div key={record.staffId} className="flex items-center gap-3 px-4 py-3">
      ...
      {saveSuccess && (
        <p className="text-sm text-center text-present font-medium">✅ Staff attendance saved!</p>
      )}
